document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('frm_miembros').addEventListener('submit', function (event) {
...
function abrirModalMiembro(tipo) {
    ...
    document.getElementById('exampleModalLabel').innerText = tipo === 'insertar' ? 'Nuevo Miembro' : 'Editar Miembro';
    $('#modalMiembro').modal('show');
}

function guardarMiembro() {
    const formData = new FormData(document.getElementById('frm_miembros'));
    formData.append('action', document.getElementById('id_miembro').value ? 'editarMiembro' : 'insertarMiembro');
